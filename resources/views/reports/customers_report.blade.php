    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ route('customers_report_search') }}" method="POST" role="search" autocomplete="off">
                    @csrf
...
<script>
    $(document).ready(function() {
        $('select[name="section"]').on('change', function() {
            ...
            if (SectionId) {
                $.ajax({
                    url: "{{ URL::to('dashboard/admin/section') }}/" + SectionId,
                    type: "GET",
                    dataType: "json",
