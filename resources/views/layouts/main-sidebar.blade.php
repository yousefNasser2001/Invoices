            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ asset('assets/img/media/avatar.jpeg') }}"><span
        ...
        <ul class="side-menu">
            ...
            @can(INVOICES_PERMISSION)
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can(INVOICES_LIST_PERMISSION)
                            <li><a class="slide-item" href="{{ route('invoices.index') }}">قائمة الفواتير</a></li>
                        @endcan
                        @can(PAID_INVOICES_PERMISSION)
                            <li><a class="slide-item" href="{{ route('paid_invoices') }}">الفواتير المدفوعة</a></li>
                        @endcan
                        @can(UNPAID_INVOICES_PERMISSION)
                            <li><a class="slide-item" href="{{ route('unpaid_invoices') }}">الفواتير الغير مدفوعة</a></li>
                        @endcan
                        @can(PARTIAL_PAID_INVOICES_PERMISSION)
                            <li><a class="slide-item" href="{{ route('partial_paid_invoices') }}">الفواتير المدفوعة جزئيا</a>
                            </li>
                        @endcan
                        @can(ARCHIVED_INVOICES_PERMISSION)
                            <li><a class="slide-item" href="{{ route('archive.index') }}">الفواتير المؤرشفة</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan

            @can(REPORTS_PERMISSION)
