            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                    ...
                    <div class="dropdown nav-item main-header-notification">
                        ...
                        <div class="dropdown-menu">
                            <div class="menu-header-content bg-primary text-right">
                                ...
                                <h6 style="color: yellow" id="notifications_count"> عدد الاشعارات الغير مقروة
                                    ...
                                    @foreach (auth()->user()->unreadNotifications as $notification)
                                        <div class="main-notification-list Notification-scroll">
                                            <a class="d-flex p-3 border-bottom"
                                                href="{{ route('invoice_details.edit', ['id' => $notification->data['id'], 'notification_id' => $notification->id]) }}">
                            ...
                            @else
                                <div class="d-flex p-3 border-bottom">
                                    لا يوجد هناك اشعارات غير مقروءة
                                </div>
                            @endif
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/media/avatar.jpeg') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex">
                                <div class="main-img-user"><img alt=""
                                        src="{{ URL::asset('assets/img/media/avatar.jpeg') }}" class=""></div>
